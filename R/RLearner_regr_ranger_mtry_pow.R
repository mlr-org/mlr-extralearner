...
#' @export
makeRLearner.regr.ranger.pow = function() {
  makeRLearnerRegr(
    cl = "regr.ranger.pow",
    package = "ranger",
    par.set = makeParamSet(
      makeIntegerLearnerParam(id = "num.trees", lower = 1L, default = 500L),
      makeNumericLearnerParam(id = "mtry.power", lower = 0L, upper = 1L),
...
#' @export
trainLearner.regr.ranger.pow = function(.learner, .task, .subset, .weights = NULL, mtry.power,...) {
...
#' @export
predictLearner.regr.ranger.pow = function(.learner, .model, .newdata, ...) {
...
#' @export
getOOBPredsLearner.regr.ranger.pow = function(.learner, .model) {
  getLearnerModel(.model, more.unwrap = TRUE)$predictions
}

#' @export
getFeatureImportanceLearner.regr.ranger.pow = function(.learner, .model, ...) {
